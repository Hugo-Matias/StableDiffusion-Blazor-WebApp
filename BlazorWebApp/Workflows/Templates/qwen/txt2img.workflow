{
  ...
  "Pipeline": [
    ...
    },
    {
      ...
      "parameters": {
        "model_shift": {{ model_shift | default: 3.10 | json }}
      }
    },
    {
      "id": "main_sampler",
    ...
    },
    {
      ...
      "parameters": {
        ...
        "unet_name": {{ detailer_checkpoint | default: Model | default: "qwen_image_fp8_e4m3fn.safetensors" | json }},
        "clip_name": {{ Clip | default: "qwen_2.5_vl_7b_fp8_scaled.safetensors" | json }},
        "clip_type": "qwen_image",
        "vae_name": {{ Vae | default: "qwen_image_vae.safetensors" | json }},
