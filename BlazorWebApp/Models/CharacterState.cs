...
public class AppStateCharacter
{
    ...
    [JsonIgnore]
    public IReadOnlyDictionary<string, string> ActiveAssets => Assets.GetActiveAssets(LoaderMode);
...
public class CharacterAssetState
{
    ...
    public IReadOnlyDictionary<string, string> GetActiveAssets(CharacterLoaderMode loaderMode)
    {
...
public static class CharacterReferenceSlotCatalog
{
    ...
    [
        Body(CharacterReferenceSlotPresetKey.FrontView, "front-view", "Front view", 1.6, CharacterReferenceDependencyPolicy.SourceImage,
            "Same exact anime woman and body proportions, same exact detailed anime artstyle, (same exact hairstyle:1.3), change pose to standing straight, both feet on the ground, natural relaxed pose, arms to the side, direct front view, eye level, adjust zoom level to get a full body portrait from feet to head. (completely white solid background)"),
        Body(CharacterReferenceSlotPresetKey.LeftProfile, "left-profile", "Left Profile", 1.4, CharacterReferenceDependencyPolicy.FrontViewOutput,
            "Same exact anime woman and body proportions, same exact detailed anime artstyle, change pose to standing, natural pose, profile view (((she is facing the left side of the frame))), full body portrait from feet to head. zoom in to maintain full body portrait. (completely white solid background)"),
        Body(CharacterReferenceSlotPresetKey.RightProfile, "right-profile", "Right Profile", 1.8, CharacterReferenceDependencyPolicy.FrontViewOutput,
            "Same exact anime woman and body proportions, same exact detailed anime artstyle, side view (((she is facing the right side of the frame))), full body portrait from feet to head. zoom in to maintain full body portrait. (completely white solid background)"),
        Body(CharacterReferenceSlotPresetKey.BackView, "back-view", "Back View", 1.6, CharacterReferenceDependencyPolicy.FrontViewOutput,
            "Same exact anime woman and body proportions, same exact detailed anime artstyle, change pose to standing, natural pose, back view (((no face visible, recreate extremely accurate hairstyle and clothes from behind))), full body portrait from feet to head. zoom in to maintain full body portrait. (completely white solid background)"),
        Body(CharacterReferenceSlotPresetKey.FrontThreeQuarter, "front-three-quarter", "Front Three-Quarter", 1.4, CharacterReferenceDependencyPolicy.FrontViewOutput,
            "Same exact anime woman and body proportions, same exact detailed anime artstyle, change pose to standing, natural pose, three-quarter view (((she is facing the left side of the frame))), full body portrait from feet to head. zoom in to maintain full body portrait. (completely white solid background)"),
        Body(CharacterReferenceSlotPresetKey.BackThreeQuarter, "back-three-quarter", "Back Three-Quarter", 1.4, CharacterReferenceDependencyPolicy.FrontViewOutput,
            "Same exact anime woman and body proportions, same exact detailed anime artstyle, change pose to standing, natural pose, three-quarter view from behind, full body portrait from feet to head. zoom in to maintain full body portrait. (completely white solid background)"),
        Expression(CharacterReferenceSlotPresetKey.NeutralExpression, "neutral", "Close Neutral", CharacterReferenceDependencyPolicy.SourceImage,
            "Same exact anime woman and facial features, same exact detailed anime artstyle, closeup of her head. natural neutral expression."),
        Expression(CharacterReferenceSlotPresetKey.HappyExpression, "happy", "Close Happy", CharacterReferenceDependencyPolicy.NeutralOutput,
            "Same exact anime woman and facial features, same exact detailed anime artstyle, closeup of her head. natural happy smiling expression. half lidded eyes."),
        Expression(CharacterReferenceSlotPresetKey.ScaredExpression, "scared", "Close Scared", CharacterReferenceDependencyPolicy.NeutralOutput,
            "Same exact anime woman and facial features, same exact detailed anime artstyle, closeup of her head. Scared expression, mouth open, eyes open very wide. Reduce irises and pupils size to very small showing a lot of sclera."),
        Expression(CharacterReferenceSlotPresetKey.AngryExpression, "angry", "Close Angry", CharacterReferenceDependencyPolicy.NeutralOutput,
            "Same exact anime woman and facial features, same exact detailed anime artstyle, closeup of her head. Angry expression, teeth slightly visible, furrowed brows."),
        Expression(CharacterReferenceSlotPresetKey.SadExpression, "sad", "Close Sad", CharacterReferenceDependencyPolicy.NeutralOutput,
            "Same exact anime woman and facial features, same exact detailed anime artstyle, closeup of her head. Sad expression, frowning or pouting."),
        Expression(CharacterReferenceSlotPresetKey.CryingExpression, "crying", "Close Crying", CharacterReferenceDependencyPolicy.NeutralOutput,
            "Same exact anime woman and facial features, same exact detailed anime artstyle, closeup of her head. Crying expression, open mouth, tears flowing down her cheeks."),
        Expression(CharacterReferenceSlotPresetKey.SmugExpression, "smug", "Close Smug", CharacterReferenceDependencyPolicy.NeutralOutput,
            "Same exact anime woman and facial features, same exact detailed anime artstyle, closeup of her head. Smug or cocky expression, half-smile without any teeth showing."),
        Pose(CharacterReferenceSlotPresetKey.ModelPose, "model-pose", "Model Pose", 1.4,
            "Same exact anime woman and body proportions, same exact detailed anime artstyle, change pose to a confident modeling pose, soft smile, half lidded eyes. full body portrait from feet to head. zoom in to maintain full body portrait. (completely white solid background)"),
        Pose(CharacterReferenceSlotPresetKey.ActionPose, "action-pose", "Action Pose", 1.4,
            "Same exact anime woman and body proportions, same exact detailed anime artstyle, change pose to a dynamic action pose, natural movement, focused and determined expression. full body portrait from feet to head. zoom in to maintain full body portrait. (completely white solid background)")
    ];
    ...
    [
        new()
        {
            ...
            PromptTemplate = "Same exact anime woman and facial features, same exact detailed anime artstyle."
        },
        new()
        {
            Id = "custom-pose",
            ...
            PromptTemplate = "Same exact anime woman and body proportions, same exact detailed anime artstyle, same exact hairstyle, and outfit."
        },
        new()
        {
            Id = "custom-camera",
            ...
            Cfg = 1.6,
            DependencyPolicy = CharacterReferenceDependencyPolicy.FrontViewOutput,
            PromptTemplate = "Same exact anime woman and body proportions, same exact detailed anime artstyle, same exact hairstyle, and outfit. Same exact facial expression and pose."
        },
        new()
        {
            Id = "custom-body",
            ...
            Cfg = 1.6,
            DependencyPolicy = CharacterReferenceDependencyPolicy.FrontViewOutput,
            PromptTemplate = "Same exact anime woman and detailed anime artstyle, same exact facial features, hairstyle, and outfit. Preserve the character identity and body proportions."
        },
        new()
        {
            Id = "custom-outfit",
            ...
            Cfg = 1.6,
            DependencyPolicy = CharacterReferenceDependencyPolicy.FrontViewOutput,
            PromptTemplate = "Same exact anime woman and body proportions, same exact detailed anime artstyle, same exact facial features and hairstyle."
        },
        new()
        {
            Id = "custom-landscape",
            ...
            Cfg = 1.6,
            DependencyPolicy = CharacterReferenceDependencyPolicy.FrontViewOutput,
            PromptTemplate = "Same exact anime woman and body proportions, same exact detailed anime artstyle."
        },
        new()
        {
            Id = "blank",
    ...
    public static string ComposePrompt(CharacterReferenceSlotState slot)
    {
        ...
        return string.IsNullOrWhiteSpace(promptExtension)
            ? promptTemplate
            : $"{promptTemplate.TrimEnd()} {promptExtension}";
    }
