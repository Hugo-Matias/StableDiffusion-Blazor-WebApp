...
namespace BlazorWebApp.Models
{
    public class ControlNetParameters
    {
        ...
        [JsonPropertyName("module")] public ControlNetPreprocessor Preprocessor { get; set; }
    ...
    public enum ControlNetPreprocessor { none, canny, depth, depth_leres, hed, misd, normal_map, openpose, openpose_hand, clip_vision, color, pidinet, scribble, fake_scrible, segmentation, binary }
}
