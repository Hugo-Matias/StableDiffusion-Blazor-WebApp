...
namespace BlazorWebApp.Models
{
    ...
    {
        [JsonPropertyName("enabled")] public string IsEnabled { get; set; }
        [JsonPropertyName("image")] public string InputImage { get; set; }
        ...
        [JsonPropertyName("low_vram")] public bool IsLowVRam { get; set; }
