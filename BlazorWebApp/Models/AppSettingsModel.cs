...
namespace BlazorWebApp.Models
{
    ...
    public class GallerySettingsModel
    {
        ...
        public GalleryOrderDirection OrderDirection { get; set; } = GalleryOrderDirection.Desc;
        public int PageSize { get; set; } = 10;
        public bool IsFavoritesOnly { get; set; } = false;
        public ModeType Mode { get; set; } = ModeType.None;
    ...
    public enum GalleryOrderDirection { Asc, Desc }
}
