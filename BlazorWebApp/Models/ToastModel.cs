namespace BlazorWebApp.Models
{
    ...
    public record ToastModel
    {
        ...
        public static ToastModel NewToast(string title, string message, MessageColor color, int secToLive) => new ToastModel { Title = title, Message = message, MessageColor = color, TimeToBurn = DateTimeOffset.Now.AddSeconds(secToLive) };
    }
}
