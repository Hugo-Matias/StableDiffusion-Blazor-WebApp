...
Use `write_to_file` to create `BlazorWebApp/Data/Odditarium/Personas/{id}.json`.
...
Use `write_to_file` to create `BlazorWebApp/wwwroot/odditarium/personas/{id}/README.md`:
...
Check the JSON file is valid. Look for compile errors.
